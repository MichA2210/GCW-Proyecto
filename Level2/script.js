...
loadOBJWithMTL('../modelos/DianaGrande/','dianaGrande.obj','dianaGrande.mtl', (objetoCargado) => {
    ...
    DianaGrande['collision'].position.z=-200;
...
loadOBJWithMTL('../modelos/DianaGrande/','dianaGrande.obj','dianaGrande.mtl', (objetoCargado) => {
    objetoCargado.position.x = -65;
    objetoCargado.position.y = -30;
    objetoCargado.position.z = -200;
    objetoCargado.scale.multiplyScalar(0.5)
    objetoCargado.rotation.y=THREE.Math.degToRad(30);
    objetoCargado.name='DianaGrande';
    DianaGrande['modelo']=objetoCargado;

    DianaGrande['collision'] = new THREE.Mesh(spheregeometry, Material);
    DianaGrande['collision'].position.x= -65;
    DianaGrande['collision'].position.y= -30;
    DianaGrande['collision'].position.z= -200;
    DianaGrande['collision'].scale.x = 25;
    DianaGrande['collision'].scale.y = 25;
...
loadOBJWithMTL('../modelos/DianaGancho/','dianaSolitaGancho.obj','dianaGold.mtl', (objetoCargado) => {
    objetoCargado.position.x = -140;
    objetoCargado.position.y = 55;
    objetoCargado.position.z = -300;
    ...
    DianaGancho['collision'].position.x= -140;
    DianaGancho['collision'].position.y= 55;
    DianaGancho['collision'].position.z= -300;
...
loadOBJWithMTL('../modelos/DianaGancho/','dianaSolitaGancho.obj','dianaSolitaGancho.mtl', (objetoCargado) => {
    objetoCargado.position.x = -100;
    objetoCargado.position.y = 62;
    objetoCargado.position.z = -400;
    objetoCargado.name='DianaGancho';
    DianaGancho['modelo']=objetoCargado;

    DianaGancho['collision'] = new THREE.Mesh(spheregeometry, Material);
    DianaGancho['collision'].position.x= -100;
    DianaGancho['collision'].position.y= 62;
    DianaGancho['collision'].position.z= -400;
    DianaGancho['collision'].scale.x = 15;
    DianaGancho['collision'].scale.y = 15;
...
loadOBJWithMTL('../modelos/DianaGancho/','dianaSolitaGancho.obj','dianaSolitaGancho.mtl', (objetoCargado) => {
    objetoCargado.position.x = -135;
    objetoCargado.position.y = 120;
...
loadOBJWithMTL('../modelos/DianaPalito/','dianaSobrePalito.obj','dianaSobrePalito.mtl', (objetoCargado) => {
    objetoCargado.position.x = 120;
    objetoCargado.position.y = -30;
    objetoCargado.position.z = -220;
    ...
    DianaPalito['collision'].position.x= 120;
    DianaPalito['collision'].position.y= -30;
    DianaPalito['collision'].position.z= -220;
...
loadOBJWithMTL('../modelos/DianaPalito/','dianaSobrePalito.obj','dianaSobrePalito.mtl', (objetoCargado) => {
    ...
    DianaPalito['collision'] = new THREE.Mesh(spheregeometry, Material);
    DianaPalito['collision'].position.x= -140;
    DianaPalito['collision'].position.y= -30;
    DianaPalito['collision'].position.z= -220;
    DianaPalito['collision'].scale.x = 1.5;
    DianaPalito['collision'].scale.y = 1.5;
...
loadOBJWithMTL('../modelos/DianaPalito/','dianaSobrePalito.obj','dianaSobrePalito.mtl', (objetoCargado) => {
    ...
    DianaPalito['collision'] = new THREE.Mesh(spheregeometry, Material);
    DianaPalito['collision'].position.x= -10;
    DianaPalito['collision'].position.y= -20;
    DianaPalito['collision'].position.z= -350;
    DianaPalito['collision'].scale.x = 1.5;
    DianaPalito['collision'].scale.y = 1.5;
...
loadOBJWithMTL('../modelos/DianaPalito/','dianaSobrePalito.obj','dianaSobrePalito.mtl', (objetoCargado) => {
    objetoCargado.position.x = 90;
    objetoCargado.position.y = -20;
    objetoCargado.position.z = -350;
    objetoCargado.scale.multiplyScalar(1)
    objetoCargado.rotation.y=THREE.Math.degToRad(-20);
    objetoCargado.name='DianaPalito';
    DianaPalito['modelo']=objetoCargado;
...
/////Bomba PowerUP///////////
loadOBJWithMTL('../modelos/Simple Bomb/model/obj/','Bomb.obj','Bomb.mtl', (objetoCargado) => {
    objetoCargado.position.x = -15;
    objetoCargado.position.y = -30;
    objetoCargado.position.z = -100;
    objetoCargado.scale.multiplyScalar(5)
    objetoCargado.name='Bomba';
    DianaGancho['modelo']=objetoCargado;
...
/////Reloj PowerUP///////////
loader.load('../modelos/reloj/source/watchModel.fbx', (model)=>{                                  //con Alt + Shift agarras varias columnas
...
/////InfinieAmo PowerUP///////////
loader.load('../modelos/bullet/source/Bullet.fbx', (model)=>{
...
function onStartSkybox() {
    ...
    textureLoader.load('fondo/Fondo2.jpg', (albedo)=> {
        albedo.wrapS = THREE.RepeatWrapping;
        albedo.wrapT = THREE.RepeatWrapping;
        albedo.repeat.multiplyScalar(textureRepeat);
        textureLoader.load('fondo/Fondo2.jpg', (normal) => {
            normal.wrapS = THREE.RepeatWrapping;
            normal.wrapT = THREE.RepeatWrapping;
            normal.repeat.multiplyScalar(textureRepeat);
            const geometry = new THREE.PlaneGeometry( 2.2, 0.7 );
            ...
            plane.position.set(0,150,-700); //0,-25,-500
